...
const ProjectSchema = CollectionSchema(
  name: 'Project',
  schema:
      '{"name":"Project","idName":"id","properties":[{"name":"estimate","type":"Long"},{"name":"name","type":"String"},{"name":"status","type":"Long"}],"indexes":[],"links":[{"name":"task","target":"ProjectTask"}]}',
  idName: 'id',
...
void _projectAttachLinks(IsarCollection col, int id, Project object) {
  object.task.attach(col, col.isar.projectTasks, 'task', id);
}
